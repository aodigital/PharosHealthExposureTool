<?php
    include '/var/www/silicatool.pharoshealth.co/public/includes/db.php'; // Assuming this file contains the DB connection
...
<head>
    ...
    <link rel="stylesheet" href="https://silicatool.pharoshealth.co/assets/css/ecp_styles.css">
    <link rel="stylesheet" href="https://silicatool.pharoshealth.co/assets/css/styles.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <title>Exposure Control Tool</title>
</head>
<body>
<div id="generate-doc-container">
  <h1>ECP Documentation for <?php echo htmlspecialchars($planning['jobsite_name'] ?? 'N/A'); ?></h1>
  ...
  <table class="summary-table">
      ...
      <tbody>
          <tr>
              <td> <?php if (!empty($work_activities)): ?> <?php foreach ($work_activities as $activity): ?> <strong><?php echo $activity; ?></strong>
                  <br>
                  <em>Placeholder text for RCS dust exposure risks and mitigation strategies.</em>
                  <br><br> <?php endforeach; ?> <?php else: ?> <p>No work activities available.</p> <?php endif; ?>
              </td>
          </tr>
      </tbody>
  </table>
  ...
  <table class="summary-table">
      ...
      <tbody>
          <tr>
              <td> This ECP sets out the plan <?php echo htmlspecialchars($meta_data['employer_name'] ?? 'N/A'); ?> will implement to protect workers from hazardous exposure to RCS dust based on information relating to the identified silica process assessed through the Pharos Health Exposure Control Tool, and the site specific details set out herein. A specific ECP is developed for each different kind of silica process identified as needed at <?php echo htmlspecialchars($meta_data['jobsite_address'] ?? 'N/A'); ?>. </td>
          </tr>
      </tbody>
  </table>
  ...
  <div class="section-separator"></div> <?php
      ...
      <table>
          ...
          <tbody>
              <tr>
                  ...
                  <td> <?php echo number_format($combined_limit, 3); ?> mg/m³<br>
                      <span id="exposure-limit-status-combined"><?php echo $combined_limit_status; ?></span>
                  </td>
                  <td> <?php echo number_format($combined_action_limit, 3); ?> mg/m³<br>
              ...
              <tr>
                  <td colspan="3">
                      <span id="risk-classification-combined" class="<?php echo $combined_risk_class; ?>"><?php echo $combined_risk_text; ?></span> <?php if (!empty($combined_risk_rec)): ?> <p id="risk-recommendation-combined"><?php echo $combined_risk_rec; ?></p> <?php endif; ?>
                  </td>
              </tr>
          </tbody>
      </table>
  ...
  </table> <?php foreach($work_activities as $index => $activity): ?> <h3>Engineering and Administrative Controls for <?php echo htmlspecialchars($activity); ?></h3>
  <table class="summary-table">
      <colgroup>
          <col style="width: 75%;">
          <col style="width: 25%;">
          ...
          <tr>
              ...
              <td> <?php
                                  ...
                                  if ($eng_note === '') {
                                      ...
                                      echo "<p class='auditor-notes'>" . htmlspecialchars($eng_note) . "</p>";
                                  }
                                  echo '<br>';
                                  ...
                                  if ($eng_img === '') {
                                      ...
                                      echo '<img src="' . htmlspecialchars($eng_img) . '" style="max-width:480px;" alt="Verification Image">';
                                  }
                                  ?> </td>
          </tr>
      </tbody>
  ...
  </table> <?php endforeach; ?> <div class="section-separator"></div> <?php 
  ...
  <div class="exposure-data-table">
      <table>
          ...
          <tbody>
              ...
              <tr>
                  <td colspan="3">
                      <span id="controlled-risk-classification-combined" class="<?php echo $controlled_combined_risk_class; ?>"><?php echo $controlled_combined_risk_text; ?></span> <?php if (!empty($combined_risk_rec)): ?> <p id="controlled-risk-recommendation-combined"><?php echo $controlled_combined_risk_rec; ?></p> <?php endif; ?>
                  </td>
              </tr>
          </tbody>
      </table>
  ...
  <table class="summary-table">
      ...
      <tbody>
          <tr>
              ...
              <td>10</td>
              <td> Half facepiece, non-powered with P100 filter<br>
                  <em> Please note, the respirator type above is an example of a respirator type that may meet the required protection factor. Users may elect to use alternate respiratory protection equipment that meets the required protection factor rating. Any respirator choice must be fitted with an N100, P100 or R100 filter. Respirators and filters must be NIOSH approved. </em>
              </td>
          </tr>
      </tbody>
  </table>
      ...
      <table>
          ...
          <tbody>
              <tr>
                  ...
                  <td> <?php echo number_format($final_combined_limit, 3); ?> mg/m³<br>
              ...
              <tr>
                  <td colspan="3">
                      <span id="final-risk-classification-combined" class="<?php echo $final_combined_risk_class; ?>"><?php echo $final_combined_risk_text; ?></span> <?php if (!empty($combined_risk_rec)): ?> <p id="final-risk-recommendation-combined"><?php echo $final_combined_risk_rec; ?></p> <?php endif; ?>
                  </td>
              </tr>
          </tbody>
      </table>
  ...
  <table class="summary-table">
      ...
      <tbody>
          <tr>
              <td> Documents and materials that augment this ECP submitted to ECP Contact;<br> ECP Summary available on jobsite as physical copy. Complete ECP available on jobsite as physical or digital copy;<br> All workers involved must have free access to this ECP and an opportunity to ask questions;<br> All documentation filed at head office for 10 years;<br> ECP must be reviewed at least annually, and updated as needed due to any changes. </td>
          </tr>
      </tbody>
  </table>
  <div id="signaturesContainer" style="display: flex; gap: 20px;"> <?php
                      $savedSignature = !empty($meta_data['creator_signature'] ) ? 'https://silicatool.pharoshealth.co/assets/images/signatures/' . $meta_data['creator_signature']  : '';
          ...
          <?php if (!empty($savedSignature)): ?> 
            <p>
              <img src="<?php echo $savedSignature ?>" alt="Plan Creators Signature" /> 
            </p>
            <p>Signed by <?php echo $plan_creator_name; ?> on <?php echo date('F j, Y', strtotime($meta_data['signing_date'])); ?> 
            </p> 
          <?php endif; ?>
      </div> <?php
                      $savedAuditorSignature = isset($verification_data['auditor_signature']) ? 'https://silicatool.pharoshealth.co/assets/images/signatures/' . $verification_data['auditor_signature'] : '';
          ...
          <?php if (!empty($savedAuditorSignature)): ?>
            <p>
              <img src="<?php echo $savedAuditorSignature ?>" alt="Verifiers Signature" /> 
            </p>
